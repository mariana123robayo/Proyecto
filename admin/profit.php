...
$tot = 0; // Inicializa $tot como un número antes de la operación de suma
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="roombook.php" href="home.php"><i class="fa fa-bar-chart-o"></i> Reserva de habitacion</a>
                    </li>
                    <li>
                        <a href="messages.php"><i class="fa fa-desktop"></i> Notificaciones
</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a  href="profit.php"><i class="fa fa-qrcode"></i> Historicos</a>
                    </li>
