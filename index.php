		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php"> MOON <span>LIGHT</span><p class="logo_w3l_agile_caption">Tu resort de ensueño</p></a></h1>
				</div>
				<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="#home" class="menu__link">Casa</a></li>
							...
							<a href="admin/home.php" target="_blank">ADMIN</a>
						</ul>
					</nav>
				</div>
			</nav>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>MOONLIGHT</h4>
								<h3>¿quieres unas vacaciones lujosas?</h3>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>MOON <span>LIGHT</span></h4>
										<img src="images/1.jpg" alt=" " class="img-responsive">
										<h5>Sabemos lo que amas</h5>
										<p>Ofrecer a los huéspedes vistas únicas y encantadoras desde sus habitaciones con sus comodidades excepcionales, hace que MOONLIGHT sea uno de los mejores en su tipo. Pruebe nuestro menú de comida, servicios increíbles y un personal amable mientras esté aquí..</p>
									</div>
								</div>
							</div>
						</div>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/reservation.php"><h2>RESERVA EL MEJOR AMANECER
</h2></a>
</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">MOONLIGHT</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
					...
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">MOONLIGHT
</span>
						</div>
					</li>
				</ul>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls"> Contamos con vistas unicas, personal maravilloso y servicios AUN mejores!
</p>
...
!</h4>
											<p>que esperas para disfrutar de tus vaciones. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>La confianza es lo primero y en MOONLIGHT no te cobramos si no disfrutase tu estancia
.</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Habitaciones amobladas con aire acondicionado
</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Balcón privado con preciosas vistas
</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		<h4>Servicio 24 horas
</h4>
			 		<p>Ya sea comida, transporte o limpieza, no te preocupes, MOONLIGHT te respalda
.</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>24 horas de servicio a la habitación
</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>24 horas de transporte privado
</p>
			 	</div>
			 </div>
			<div class="clearfix"> </div>
			...
			<div id="horizontalTab">
					...
					<div class="col-md-6 team-img-w3-agile" >
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Mariana Robayo</h4>
							<span>Gerente
</span>
							<p>En este hotel, no solo creamos experiencias, sino que construimos recuerdos inolvidables. Nuestra misión es ofrecer a nuestros huéspedes no solo un lugar para descansar, sino un refugio donde puedan sentirse verdaderamente bienvenidos y atendidos.</p>	
...
<!-- //gallery -->
  ...
  <!-- visitors -->
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Sinceramente... EL MEJOR LUGAR EN QUE HE ESTADO NUNCA.</p>
								<h5>Julia Rose</h5>
								<p>Tunja, Colombia</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Un escape al caos de la ciudad, me gusto mucho la experiencia.</p>
						...
						Vale la pena volver
								...
								<p>Maravillosas vistas y una atencion perfecta, nada mas que pedir. </p>
	...
	Vale la pena volver
								...
								<p>Me gusto la experiencia, el trafico no tanto... </p>
								<h5>Serge Leonard</h5>
								<p>Suiza</p>
							</div>
							<div class="clearfix"> </div>
...
:</label>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Teléfono :</strong>+57 320 992 3144</p>
			<p class="contact-agile1"><strong>Email :</strong> <a>hotelmoonlight@gmail.com</a></p>
			<p class="contact-agile1"><strong>Dirección :</strong> Bucaramanga, Colombia</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.4638300311767!2d-73.1081013260189!3d7.072097992930585!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e683f7178598f19%3A0x3e483f8c97a868ba!2sSonesta%20Hotel%20Bucaramanga!5e0!3m2!1ses!2sus!4v1701907885208!5m2!1ses!2sus" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
